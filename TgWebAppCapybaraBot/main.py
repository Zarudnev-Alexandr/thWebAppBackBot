...
start_dialog = Dialog(
    Window(
        ...
        Format('🌟 Добро пожаловать! 🌟\n\n'
               ...
               'гармонии🌿.\n\n'
               '❗️Вы удивитесь тому что произойдет через 7 дней❗️\n\n'
               ...
               'В конце пути вас ждет особый подарок — уникальная коллекционная '
               'NFT из коллекции <a href="https://getgems.io/harmonara">Harmonara 🧘‍♀️</a>,'
        ...
        Const('Что бы пользоваться ботом подпишись на канал и ты будешь в курсе всех '
              'новостей и обновлений 👉 https://t.me/Harmonara\n\nЗатем просто заново напиши /start 😉',
              when='not_subscribe'),
        Group(
            WebApp(Const('Приступить к медитации'), Const('https://zarudnev-alexandr.github.io/tgCapybaraFront/')),
            when='admin'
        ),
        Group(
            WebApp(Const('Приступить к медитации'), Const('https://zarudnev-alexandr.github.io/tgCapybaraFront/')),
